...
export function StatusBadge({ status }: { status: string }) {
  ...
  /*
   * お支払いは、決済方法によって言い方を変えている（lib/payment-status.ts の paymentStatusLabel）。
   *   銀行振込 … 着金待ち → 着金完了
   *   アプラス … 決済中　 → 決済完了
   * 新しい言い方をここに足していなかったため、「着金完了」「決済中」だけ
   * どの組にも入らず灰色で出ていた（2026-08-31）。
   */
  const good = ["配達完了", "出荷済", "承認", "承認済", "稼働中", "合格", "支払済", "照合済", "決済完了", "着金完了", "審査完了"];
  const warn = ["出荷手配中", "出荷待ち", "申請中", "電話確認待ち", "未支払", "受講中", "要確認", "着金待ち", "決済中", "審査中"];
